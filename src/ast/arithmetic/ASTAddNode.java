...
public final class ASTAddNode implements JasvaASTNode {

    private final JasvaASTNode _left;
    private final JasvaASTNode _right;

    public ASTAddNode(final JasvaASTNode left, final JasvaASTNode right) {
        _left = left;
        _right = right;
    }
    ...
    public final Value<?> evaluate(Environment<Value<?>> symbolTable) {
        ...
        if(leftVal instanceof IntValue) {
            ...
            if(rightVal instanceof IntValue) {
                return ((IntValue) leftVal).add((IntValue) rightVal);
            }
            throw new TypeException("addition", "right hand side is not an integer value");
        }
        throw new TypeException("addition", "left hand side is not an integer value");
    }
    ...
    public final void compile(CompiledClass<JasminCompiler> classContext, JasminCompiler compiler, Environment<Pair<Integer, String>> symbolLinker) {
        ...
        compiler.pushInstruction(JasvaInstructionSet.ADD.instance());
    }
