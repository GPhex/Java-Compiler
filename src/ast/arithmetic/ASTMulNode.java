...
public final class ASTMulNode implements JasvaASTNode {

    private final JasvaASTNode _left;
    private final JasvaASTNode _right;

    public ASTMulNode(final JasvaASTNode left, final JasvaASTNode right) {
        _left = left;
        _right = right;
    }
    ...
    public final Value<?> evaluate(Environment<Value<?>> symbolTable) {
        ...
        if(leftVal instanceof IntValue) {
            ...
            if(rightVal instanceof IntValue) {
                return ((IntValue) leftVal).mul((IntValue) rightVal);
            }
            throw new TypeException("multiplication", "right hand side is not an integer value");
        }
        throw new TypeException("multiplication", "left hand side is not an integer value");
    }
    ...
    public final void compile(CompiledClass<JasminCompiler> classContext, JasminCompiler compiler, Environment<Pair<Integer, String>> symbolLinker) {
        ...
        compiler.pushInstruction(JasvaInstructionSet.MUL.instance());
    }
